...
public class JSON1Raw implements ObjectPayloadRaw<Object> {

    public Map getObject ( Object command ) throws Exception {
        return makeCallerChain(GadgetUtils.createTemplatesImpl(command), Templates.class);
    }

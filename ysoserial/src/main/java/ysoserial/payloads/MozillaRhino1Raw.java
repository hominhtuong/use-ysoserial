...
public class MozillaRhino1Raw implements ObjectPayloadRaw<Object> {
    ...
    public Object getObject(final Object command) throws Exception {
        ...
        NativeJavaObject nativeObject = new NativeJavaObject(scriptableObject, GadgetUtils.createTemplatesImpl(command), TemplatesImpl.class);
